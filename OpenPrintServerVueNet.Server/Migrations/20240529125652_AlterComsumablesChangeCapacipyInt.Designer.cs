...
namespace OpenPrintServerVueNet.Server.Migrations
{
    ...
    [Migration("20240529125652_AlterComsumablesChangeCapacipyInt")]
    partial class AlterComsumablesChangeCapacipyInt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenPrintServerVueNet.Models.Job", b =>
                {
                    ...
                    b.Property<int?>("BytesPrinted")
                        .HasColumnType("int");

                    b.Property<int?>("BytesTotal")
                        .HasColumnType("int");
                    ...
                    b.Property<short?>("Printer_Copies")
                        .HasColumnType("smallint");

                    b.Property<int?>("Printer_DefaultSource")
                        .HasColumnType("int");

                    b.Property<string>("Printer_FormName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("Printer_Orientation")
                        .HasColumnType("int");

                    b.Property<int?>("Printer_Palette")
                        .HasColumnType("int");

                    b.Property<int?>("Printer_Paper_Size")
                        .HasColumnType("int");

                    b.Property<int?>("Printer_PrintQuality_X")
                        .HasColumnType("int");

                    b.Property<int?>("Printer_PrintQuality_Y")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OpenPrintServerVueNet.Server.Models.Config", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OpenPrintServerVueNet.Server.Models.PrinterPort", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PrinterPorts");
                });

            modelBuilder.Entity("OpenPrintServerVueNet.Server.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OpenPrintServerVueNet.Server.Models.User", null)
                        .WithMany()
